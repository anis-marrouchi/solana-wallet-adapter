...
// @todo overwrite FC<ButtonProps> for demo purposes we keep it simple: no typing
// We have added: onConnect to the props
export const WalletMultiButton: FC<any> = ({
    ...
    if (!base58) {
        return (
            <WalletConnectButton onClick={(e) => onConnect(e)} color={color} variant={variant} type={type} {...props}>
                {children}
            </WalletConnectButton>
        );
    }
